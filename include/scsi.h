...
typedef enum {
	DEVICE_CLOCK_POWER_ON = 0,
	DEVICE_CLOCK_RESERVED_1 = 1,
	DEVICE_CLOCK_SET_TIMESTAMP = 2,
	DEVICE_CLOCK_UNKNOWN = 3,
	DEVICE_CLOCK_RESERVED_2 = 4,
	DEVICE_CLOCK_RESERVED_3 = 5,
	DEVICE_CLOCK_RESERVED_4 = 6,
	DEVICE_CLOCK_RESERVED_5 = 7,
} device_clock_e;
